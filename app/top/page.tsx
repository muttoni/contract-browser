...
export default function TopContracts() {
  ...
  return (
    ...
    <div className="py-6">
      <h2 className="text-3xl font-bold tracking-tight">Most importing</h2>
      <p className="text-muted-foreground">The top 500 contracts on {network}, ranked by number of contracts imported.</p>
    </div>
